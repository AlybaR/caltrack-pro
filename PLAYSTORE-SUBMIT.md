...
> Guide complet pour publier Meki sur le Play Store en mode **TWA** (Trusted Web Activity).
...
2. Couleur de fond : `#D4633A` (terracotta Meki)
...
6. Configure :
   - **Package ID** : `io.github.alybar.meki` (à conserver, c'est ton bundle ID)
   - **App name** : `Meki`
   - **Launcher name** : `Meki`
   - **App version** : `1.0.0`
   - **Version code** : `1`
...
6. Test final : https://developers.google.com/digital-asset-links/tools/generator
   ...
   - Package name : `io.github.alybar.meki`
...
- **Ads** : No ads
- **Content rating** : remplis le questionnaire (Meki = "Reference" + "Health & Fitness", pas de violence, pas de contenu adulte → rating PEGI 3 ou Tous publics)
...
4. **Release notes** :
   ```
   🎉 Première version publique de Meki !
...
- Apps simples (comme Meki) : **24-72h**
...
Quand tu coches tout ça → **Meki est en review chez Google.** 🚀
